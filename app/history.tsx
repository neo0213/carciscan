...
export default function HistoryScreen() {
  ...
  return (
    <View
      style={[s.root, { backgroundColor: colors.bg, paddingTop: insets.top }]}
    >
            ...
            return (
              ...
              >
                <View style={s.cardTop}>
                  <View style={{ flex: 1 }}>
                    <Text
                      style={[s.scanName, { color: colors.text }]}
                      numberOfLines={1}
                    >
                      {scan.scan_name ||
                    ...
                    <Text style={[s.scanMeta, { color: colors.textTertiary }]}>
                      ...
                      {detected.length}/{scan.ingredients.length} detected
                    </Text>
                  </View>
                  <View style={s.cardRight}>
                    {rs && worst && (
                      <View style={[s.pill, { backgroundColor: rs.bg }]}>
                        <Text style={[s.pillText, { color: rs.fg }]}>
                          {worst}
                        </Text>
                      </View>
                    )}
                ...
                {/* Quick actions row */}
                <View
                  style={[s.cardActions, { borderTopColor: colors.border }]}
                >
                  <TouchableOpacity
                    onPress={(e) => {
                      e.stopPropagation();
                  ...
                  >
                    <Ionicons
                      ...
                      color={colors.accent}
                    />
                    <Text style={[s.cardActionText, { color: colors.accent }]}>
                      Rename
                    </Text>
                  </TouchableOpacity>
                  <TouchableOpacity
                  ...
                  >
                    <Ionicons
                      ...
                      color={colors.danger}
                    />
                    <Text style={[s.cardActionText, { color: colors.danger }]}>
                      Delete
                    </Text>
                  </TouchableOpacity>
                </View>
